 ...
 */
define(['accUtils',"knockout" , "ojs/ojarraydataprovider","ojs/ojselectsingle", "ojs/ojlabel",'ojs/ojchart'],
 function(accUtils,ko,ArrayDataProvider) {
    function DashboardViewModel() {
      ...
      self.chartTypes =  new ArrayDataProvider(types,
        {keyAttributes: 'value'});
      ...
      console.log(self.chartDataProvider)
